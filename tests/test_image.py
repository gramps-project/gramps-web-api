...
def make_two_page_pdf(color1=(255, 0, 0), color2=(0, 0, 255), size=(200, 200)) -> io.BytesIO:
...
def test_pdf_thumbnail_size_capped():
    """Rendered PDF thumbnail must not exceed the 2000×2000 cap."""
