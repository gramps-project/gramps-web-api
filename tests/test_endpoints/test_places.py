...
class TestPlaces:
    ...
    def test_get_places_conforms_to_schema(self, test_adapter):
        ...
        check_conforms_to_schema(
            test_adapter, TEST_URL + "?extend=all&profile=all&backlinks=1", "Place"
        )

    def test_get_places_expected_results_total(
        self, test_adapter, example_object_counts
    ):
        """Test expected number of results returned."""
        check_totals(
            test_adapter, TEST_URL + "?keys=handle", example_object_counts["places"]
        )
    ...
    def test_get_places_parameter_keys_expected_result_multiple_keys(
        self, test_adapter
    ):
        """Test keys parameter for multiple keys produces expected result."""
        check_keys_parameter(
            test_adapter, TEST_URL, [",".join(["alt_loc", "handle", "urls"])]
        )
    ...
    def test_get_places_parameter_skipkeys_expected_result_single_key(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_skipkeys_expected_result_multiple_keys(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_sort_change_ascending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter change ascending result."""
        check_sort_parameter(test_adapter, TEST_URL, "change")

    def test_get_places_parameter_sort_change_descending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter change descending result."""
        check_sort_parameter(test_adapter, TEST_URL, "change", direction="-")

    def test_get_places_parameter_sort_gramps_id_ascending_expected_result(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_sort_gramps_id_descending_expected_result(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_sort_latitude_ascending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter latitude ascending result."""
        check_sort_parameter(test_adapter, TEST_URL, "latitude", value_key="lat")

    def test_get_places_parameter_sort_latitude_descending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter latitude descending result."""
        check_sort_parameter(
            test_adapter, TEST_URL, "latitude", value_key="lat", direction="-"
        )

    def test_get_places_parameter_sort_longitude_ascending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter longitude ascending result."""
        check_sort_parameter(test_adapter, TEST_URL, "longitude", value_key="long")

    def test_get_places_parameter_sort_longitude_descending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter longitude descending result."""
        check_sort_parameter(
            test_adapter, TEST_URL, "longitude", value_key="long", direction="-"
        )

    def test_get_places_parameter_sort_private_ascending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter private ascending result."""
        check_sort_parameter(test_adapter, TEST_URL, "private")

    def test_get_places_parameter_sort_private_descending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter private descending result."""
        check_sort_parameter(test_adapter, TEST_URL, "private", direction="-")

    def test_get_places_parameter_sort_title_ascending_expected_result(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_sort_title_descending_expected_result(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_sort_type_ascending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter type ascending result."""
        check_sort_parameter(test_adapter, TEST_URL, "type", value_key="place_type")

    def test_get_places_parameter_sort_type_descending_expected_result(
        self, test_adapter
    ):
        """Test sort parameter type descending result."""
        check_sort_parameter(
            test_adapter, TEST_URL, "type", value_key="place_type", direction="-"
        )

    def test_get_places_parameter_sort_type_ascending_expected_result_with_locale(
        self, test_adapter
    ):
        """Test sort parameter type ascending result using different locale."""
        rv = check_success(
            test_adapter, TEST_URL + "?keys=place_type&sort=+type&locale=de"
        )
    ...
    def test_get_places_parameter_rules_validate_syntax(self, test_adapter):
        ...
        check_invalid_syntax(
            test_adapter, TEST_URL + '?rules={"rules"[{"name":"HasNoLatOrLon"}]}'
        )
    ...
    def test_get_places_parameter_rules_missing_content(self, test_adapter):
        ...
        check_resource_missing(
            test_adapter, TEST_URL + '?rules={"rules":[{"name":"Shire"}]}'
        )

    def test_get_places_parameter_rules_expected_response_single_rule(
        self, test_adapter
    ):
        """Test rules parameter expected response for a single rule."""
        rv = check_success(
            test_adapter,
            TEST_URL + '?keys=lat,long&rules={"rules":[{"name":"HasNoLatOrLon"}]}',
        )
        for item in rv:
            assert item["lat"] == ""
            assert item["long"] == ""

    def test_get_places_parameter_rules_expected_response_multiple_rules(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_rules_expected_response_or_function(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_rules_expected_response_one_function(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_extend_expected_result_citation_list(
        self, test_adapter
    ):
    ...
    def test_get_places_parameter_backlinks_expected_result(self, test_adapter):
        ...
        rv = check_success(
            test_adapter, TEST_URL + "?gramps_id=P1108&keys=backlinks&backlinks=1"
        )
...
class TestPlacesHandle:
    ...
    def test_get_places_handle_validate_semantics(self, test_adapter):
        """Test invalid parameters and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?junk_parm=1"
        )
    ...
    def test_get_places_handle_parameter_strip_expected_result(self, test_adapter):
        """Test strip parameter produces expected result."""
        check_strip_parameter(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J", paginate=False
        )

    def test_get_places_handle_parameter_keys_validate_semantics(self, test_adapter):
        """Test invalid keys parameter and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?keys", check="base"
        )

    def test_get_places_handle_parameter_keys_expected_result_single_key(
        self, test_adapter
    ):
        """Test keys parameter for some single keys produces expected result."""
        check_keys_parameter(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J", ["alt_loc", "handle", "urls"]
        )

    def test_get_places_handle_parameter_keys_expected_result_multiple_keys(
        self, test_adapter
    ):
        """Test keys parameter for multiple keys produces expected result."""
        check_keys_parameter(
    ...
    def test_get_places_handle_parameter_skipkeys_validate_semantics(
        self, test_adapter
    ):
        """Test invalid skipkeys parameter and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?skipkeys", check="base"
        )

    def test_get_places_handle_parameter_skipkeys_expected_result_single_key(
        self, test_adapter
    ):
        """Test skipkeys parameter for some single keys produces expected result."""
        check_skipkeys_parameter(
    ...
    def test_get_places_handle_parameter_skipkeys_expected_result_multiple_keys(
        self, test_adapter
    ):
        """Test skipkeys parameter for multiple keys produces expected result."""
        check_skipkeys_parameter(
    ...
    def test_get_places_handle_parameter_extend_validate_semantics(self, test_adapter):
        """Test invalid extend parameter and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?extend", check="list"
        )

    def test_get_places_handle_parameter_extend_expected_result_citation_list(
        self, test_adapter
    ):
        """Test extend citation_list result."""
        check_single_extend_parameter(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J", "citation_list", "citations"
        )

    def test_get_places_handle_parameter_extend_expected_result_media_list(
        self, test_adapter
    ):
        """Test extend media_list result."""
        check_single_extend_parameter(
    ...
    def test_get_places_handle_parameter_extend_expected_result_notes(
        self, test_adapter
    ):
        """Test extend notes result."""
        check_single_extend_parameter(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J", "note_list", "notes"
        )

    def test_get_places_handle_parameter_extend_expected_result_tag_list(
        self, test_adapter
    ):
        """Test extend tag_list result."""
        check_single_extend_parameter(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J", "tag_list", "tags"
        )

    def test_get_places_handle_parameter_extend_expected_result_all(self, test_adapter):
        """Test extend all result."""
        rv = check_success(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?extend=all&keys=extended"
        )
        assert len(rv["extended"]) == 4
        for key in ["citations", "media", "notes", "tags"]:
            assert key in rv["extended"]

    def test_get_places_handle_parameter_extend_expected_result_multiple_keys(
        self, test_adapter
    ):
        """Test extend result for multiple keys."""
        rv = check_success(
    ...
    def test_get_places_handle_parameter_profile(self, test_adapter):
        """Test place profile."""
        rv = check_success(
            test_adapter, TEST_URL + "08TJQCCFIX31BXPNXN?profile=self&locale=it"
        )
        assert rv["profile"] == {
            "alternate_names": [],
    ...
    def test_get_places_handle_parameter_profile_alternative_names(self, test_adapter):
        """Test place profile."""
        rv = check_success(
            test_adapter, TEST_URL + "fce62795df51c5d8ae432e3942c?profile=all&locale=en"
        )
        assert rv["profile"] == {
    ...
    def test_get_places_handle_parameter_backlinks_validate_semantics(
        self, test_adapter
    ):
        """Test invalid backlinks parameter and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "YNUJQC8YM5EGRG868J?backlinks", check="boolean"
        )

    def test_get_places_handle_parameter_backlinks_expected_result(self, test_adapter):
        """Test backlinks expected result."""
        rv = check_boolean_parameter(
            test_adapter, TEST_URL + "09UJQCF3TNGH9GU0P1", "backlinks"
        )
        for key in ["a5af0ec6378200d83f5", "a5af0ec671815ecc2b6"]:
            assert key in rv["backlinks"]["event"]

    def test_get_places_handle_parameter_backlinks_expected_results_extended(
        self, test_adapter
    ):
        """Test backlinks extended result."""
        rv = check_success(
            test_adapter, TEST_URL + "09UJQCF3TNGH9GU0P1?backlinks=1&extend=backlinks"
        )
