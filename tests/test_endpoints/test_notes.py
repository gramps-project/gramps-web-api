...
class TestNotes:
    ...
    @classmethod
    def test_get_notes_requires_token(self, test_adapter):
        """Test authorization required."""
        check_requires_token(test_adapter, TEST_URL)

    def test_get_notes_conforms_to_schema(self, test_adapter):
    ...
    def test_get_notes_expected_results(self, test_adapter):
        ...
        assert rv[0]["gramps_id"] == "N0001"
        assert rv[0]["handle"] == "ac380498bac48eedee8"
        assert rv[0]["type"] == "Name Note"
        # check last expected record
        assert rv[-1]["gramps_id"] == "_custom1"
        assert rv[-1]["handle"] == "d0436be64ac277b615b79b34e72"
        assert rv[-1]["type"] == "General"

    def test_get_notes_validate_semantics(self, test_adapter):
        """Test invalid parameters and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?junk_parm=1")

    def test_get_notes_parameter_gramps_id_validate_semantics(self, test_adapter):
        """Test invalid gramps_id parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?gramps_id", check="base")

    def test_get_notes_parameter_gramps_id_missing_content(self, test_adapter):
        """Test response for missing gramps_id object."""
        check_resource_missing(test_adapter, TEST_URL + "?gramps_id=does_not_exist")

    def test_get_notes_parameter_gramps_id_expected_result(self, test_adapter):
        """Test gramps_id parameter returns expected result."""
        rv = check_success(test_adapter, TEST_URL + "?gramps_id=_header1")
        assert len(rv) == 1
        assert rv[0]["handle"] == "d0436bba4ec328d3b631259a4ee"

    def test_get_notes_parameter_strip_validate_semantics(self, test_adapter):
        """Test invalid strip parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?strip", check="boolean")

    def test_get_notes_parameter_strip_expected_result(self, test_adapter):
        """Test strip parameter produces expected result."""
        check_strip_parameter(test_adapter, TEST_URL)

    def test_get_notes_parameter_keys_validate_semantics(self, test_adapter):
        """Test invalid keys parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?keys", check="base")

    def test_get_notes_parameter_keys_expected_result_single_key(self, test_adapter):
        """Test keys parameter for some single keys produces expected result."""
        check_keys_parameter(test_adapter, TEST_URL, ["change", "handle", "type"])
    ...
    def test_get_notes_parameter_page_validate_semantics(self, test_adapter):
        """Test invalid page parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?page", check="number")

    def test_get_notes_parameter_pagesize_validate_semantics(self, test_adapter):
        """Test invalid pagesize parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?pagesize", check="number")

    def test_get_notes_parameter_page_pagesize_expected_result(self, test_adapter):
    ...
    def test_get_notes_parameter_sort_validate_semantics(self, test_adapter):
    ...
    def test_get_notes_parameter_sort_type_descending_expected_result_with_locale(
        ...
        assert rv[-1]["type"] == "Transcript"

    def test_get_notes_parameter_filter_validate_semantics(self, test_adapter):
    ...
    def test_get_notes_parameter_rules_validate_semantics(self, test_adapter):
        """Test invalid rules parameter and values."""
    ...
    def test_get_notes_parameter_rules_missing_content(self, test_adapter):
    ...
    def test_get_notes_parameter_rules_expected_response_invert(self, test_adapter):
    ...
    def test_get_notes_parameter_extend_validate_semantics(self, test_adapter):
        """Test invalid extend parameter and values."""
        check_invalid_semantics(test_adapter, TEST_URL + "?extend", check="list")

    def test_get_notes_parameter_extend_expected_result_tag_list(self, test_adapter):
        """Test extend tag_list result."""
        check_single_extend_parameter(
            test_adapter, TEST_URL + "?gramps_id=N0011", "tag_list", "tags", join="&"
        )
    ...
    def test_get_notes_parameter_backlinks_validate_semantics(self, test_adapter):
...
class TestNotesHandle:
    """Test cases for the /api/notes/{handle} endpoint for a specific note."""

    @classmethod
    def test_get_notes_handle_requires_token(self, test_adapter):
        """Test authorization required."""
        check_requires_token(test_adapter, TEST_URL + "ac3804aac6b762b75a5")

    def test_get_notes_handle_conforms_to_schema(self, test_adapter):
        """Test conforms to schema."""
        check_conforms_to_schema(
            test_adapter,
    ...
    def test_get_notes_handle_missing_content(self, test_adapter):
        """Test response for missing content."""
        check_resource_missing(test_adapter, TEST_URL + "does_not_exist")

    def test_get_notes_handle_expected_result(self, test_adapter):
        """Test response for a specific event."""
        rv = check_success(test_adapter, TEST_URL + "ac3804aac6b762b75a5")
        assert rv["gramps_id"] == "N0008"
    ...
    def test_get_notes_handle_parameter_strip_validate_semantics(self, test_adapter):
        """Test invalid strip parameter and values."""
        check_invalid_semantics(
            test_adapter, TEST_URL + "ac3804aac6b762b75a5?strip", check="boolean"
        )
    ...
    def test_get_notes_handle_parameter_skipkeys_validate_semantics(self, test_adapter):
        """Test invalid skipkeys parameter and values."""
        check_invalid_semantics(
    ...
    def test_get_notes_handle_parameter_extend_validate_semantics(self, test_adapter):
        """Test invalid extend parameter and values."""
        check_invalid_semantics(
    ...
    def test_get_notes_handle_parameter_extend_expected_result_all(self, test_adapter):
        """Test extend all result."""
        rv = check_success(
            test_adapter, TEST_URL + "ac3804aac6b762b75a5?extend=all&keys=extended"
        )
    ...
    def test_get_notes_handle_parameter_backlinks_expected_result(self, test_adapter):
        """Test backlinks expected result."""
        rv = check_boolean_parameter(
            test_adapter, TEST_URL + "b39ff01f75c1f76859a", "backlinks"
        )
        for key in ["GNUJQCL9MD64AM56OH"]:
    ...
    def test_get_notes_handle_parameter_formats_html(self, test_adapter):
        """Test formats for html."""
        rv = check_success(test_adapter, TEST_URL + "b39ff01f75c1f76859a?formats=html")
        assert "formatted" in rv
    ...
    def test_get_notes_link_format(self, test_adapter):
